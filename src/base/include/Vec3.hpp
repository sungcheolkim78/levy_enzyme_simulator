...
template <class T> class Vec3 {
    ...
    public:
        ...
        Vec3(Vec3<T>&& v) { this->x = v.x; this->y = v.y; this->z = v.z; }
        ...
        void X(const T &xValue) { x = xValue; }
        void Y(const T &yValue) { y = yValue; }
        void Z(const T &zValue) { z = zValue; }
        void setXYZ(const T &xValue, const T &yValue, const T &zValue) {
